...
const (
	...
	MessageType_MessageType_TstchainGetAddress       MessageType = 56
	MessageType_MessageType_TstchainAddress          MessageType = 57
	MessageType_MessageType_TstchainSignTx           MessageType = 58
	MessageType_MessageType_TstchainTxRequest        MessageType = 59
	MessageType_MessageType_TstchainTxAck            MessageType = 60
	...
	MessageType_MessageType_TstchainSignMessage      MessageType = 64
	MessageType_MessageType_TstchainVerifyMessage    MessageType = 65
	MessageType_MessageType_TstchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_TstchainGetAddress",
	57:  "MessageType_TstchainAddress",
	58:  "MessageType_TstchainSignTx",
	59:  "MessageType_TstchainTxRequest",
	60:  "MessageType_TstchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_TstchainSignMessage",
	65:  "MessageType_TstchainVerifyMessage",
	66:  "MessageType_TstchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_TstchainGetAddress":       56,
	"MessageType_TstchainAddress":          57,
	"MessageType_TstchainSignTx":           58,
	"MessageType_TstchainTxRequest":        59,
	"MessageType_TstchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_TstchainSignMessage":      64,
	"MessageType_TstchainVerifyMessage":    65,
	"MessageType_TstchainMessageSignature": 66,
...
// *
// Request: Ask device for Tstchain address corresponding to address_n path
// @next PassphraseRequest
// @next TstchainAddress
// @next Failure
type TstchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *TstchainGetAddress) Reset()                    { *m = TstchainGetAddress{} }
func (m *TstchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*TstchainGetAddress) ProtoMessage()               {}
func (*TstchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *TstchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TstchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Tstchain address derived from device private seed
// @prev TstchainGetAddress
type TstchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TstchainAddress) Reset()                    { *m = TstchainAddress{} }
func (m *TstchainAddress) String() string            { return proto.CompactTextString(m) }
func (*TstchainAddress) ProtoMessage()               {}
func (*TstchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *TstchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next TstchainTxRequest
// @next Failure
type TstchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *TstchainSignTx) Reset()                    { *m = TstchainSignTx{} }
func (m *TstchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*TstchainSignTx) ProtoMessage()               {}
func (*TstchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *TstchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TstchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *TstchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *TstchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *TstchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *TstchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *TstchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *TstchainSignTx) GetDataLength() uint32 {
...
func (m *TstchainSignTx) GetChainId() uint32 {
...
func (m *TstchainTxRequest) Reset()                    { *m = TstchainTxRequest{} }
func (m *TstchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*TstchainTxRequest) ProtoMessage()               {}
func (*TstchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *TstchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *TstchainTxRequest) GetSignatureV() uint32 {
...
func (m *TstchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *TstchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev TstchainTxRequest
// @next TstchainTxRequest
type TstchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TstchainTxAck) Reset()                    { *m = TstchainTxAck{} }
func (m *TstchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*TstchainTxAck) ProtoMessage()               {}
func (*TstchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *TstchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next TstchainMessageSignature
// @next Failure
type TstchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *TstchainSignMessage) Reset()                    { *m = TstchainSignMessage{} }
func (m *TstchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*TstchainSignMessage) ProtoMessage()               {}
func (*TstchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *TstchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TstchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type TstchainVerifyMessage struct {
...
func (m *TstchainVerifyMessage) Reset()                    { *m = TstchainVerifyMessage{} }
func (m *TstchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*TstchainVerifyMessage) ProtoMessage()               {}
func (*TstchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *TstchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *TstchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *TstchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev TstchainSignMessage
type TstchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TstchainMessageSignature) Reset()                    { *m = TstchainMessageSignature{} }
func (m *TstchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*TstchainMessageSignature) ProtoMessage()               {}
func (*TstchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *TstchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *TstchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TstchainGetAddress)(nil), "TstchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*TstchainAddress)(nil), "TstchainAddress")
	...
	proto.RegisterType((*TstchainSignTx)(nil), "TstchainSignTx")
	proto.RegisterType((*TstchainTxRequest)(nil), "TstchainTxRequest")
	proto.RegisterType((*TstchainTxAck)(nil), "TstchainTxAck")
	proto.RegisterType((*TstchainSignMessage)(nil), "TstchainSignMessage")
	proto.RegisterType((*TstchainVerifyMessage)(nil), "TstchainVerifyMessage")
	proto.RegisterType((*TstchainMessageSignature)(nil), "TstchainMessageSignature")
