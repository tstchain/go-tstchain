...
func makeHeaderChain(parent *types.Header, n int, db tstdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (tstdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() tstdb.Database {
	return odr.db
}
