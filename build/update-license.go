...
Please review the resulting diff to check whtster the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-tstereum authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-tstereum Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-tstereum library"
	}
	return "the go-tstereum library"
}
