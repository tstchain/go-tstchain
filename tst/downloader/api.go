...
// Syncing provides information when this nodes starts synchronising with the Tstchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  tstereum.SyncProgress `json:"status"`
}
