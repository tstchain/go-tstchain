...
import (
	...
	"github.com/tstchain/go-tstchain/contracts/chequebook"
	"github.com/tstchain/go-tstchain/contracts/ens"
	...
	"github.com/tstchain/go-tstchain/swarm/api"
	httpapi "github.com/tstchain/go-tstchain/swarm/api/http"
	"github.com/tstchain/go-tstchain/swarm/fuse"
	"github.com/tstchain/go-tstchain/swarm/network"
	"github.com/tstchain/go-tstchain/swarm/storage"
)
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := tstclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := tstclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
