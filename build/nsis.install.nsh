Name "gtst ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/tstchain/go-tstchain/issues"
!define UPDATEURL "https://github.com/tstchain/go-tstchain/releases"
!define ABOUTURL "https://github.com/tstchain/go-tstchain#tstereum-go"
...
# Install gtst binary
Section "Gtst" GTST_IDX
  SetOutPath $INSTDIR
  file {{.Gtst}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtst.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtst.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gtst incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtst outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gtst UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gtst incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gtst.exe" "" "" "Tstchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gtst outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gtst.exe" "" "" "Tstchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gtst UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gtst.exe" "" "" "Tstchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/tstereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "TSTEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gtst.ipc"
  ${EnvVarUpdate} $0 "TSTEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gtst.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GTST_IDX}
    SectionGetSize ${GTST_IDX} $0
