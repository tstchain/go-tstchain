...
type operation struct {
	...
	halts   bool // indicates whtster the operation should halt further execution
	jumps   bool // indicates whtster the program counter should not increment
	writes  bool // determines whtster this a state modifying operation
	valid   bool // indication whtster the retrieved operation is valid and known
	reverts bool // determines whtster the operation reverts state (implicitly halts)
	returns bool // determines whtster the operations sets the return data content
}
