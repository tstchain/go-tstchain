...
type accessTestFn func(db tstdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db tstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db tstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db tstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db tstdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
