...
// Package tests implements execution of Tstchain JSON tests.
package tests
...
/* See https://github.com/tstereum/tests/wiki/Blockchain-Tests-II

   Whtster a block is valid or not is a bit subtle, it's defined by presence of
