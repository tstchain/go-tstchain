...
type GlogHandler struct {
	...
	override  uint32 // Flag whtster overrides are used, atomically accessible
	backtrace uint32 // Flag whtster backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whtster this is the callsite
