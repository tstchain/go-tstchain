...
// Package state provides a caching layer atop the Tstchain state trie.
package state
...
// StateDBs within the tstereum protocol are used to store anything
...
// Exist reports whtster the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whtster the state object is either non-existent
...
//
// Carrying over the balance ensures that Tster doesn't disappear.
