...
var ProtocolName = "tst"

// Supported versions of the tst protocol (first is primary).
var ProtocolVersions = []uint{tst63, tst62}
...
// tst protocol message codes
const (
	// Protocol messages belonging to tst/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to tst/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
