...
# 1. install gtst for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gtst
# 5. create gtst, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable TSTEREUM_SOCKET
...
!define GROUPNAME "Tstchain"
!define APPNAME "Gtst"
!define DESCRIPTION "Official Go implementation of the Tstchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gtst is installed global
