...
// to the TST network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whtster a transaction is valid according to the consensus rules.
