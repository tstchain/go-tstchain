...
// Package chequebook package wraps the 'chequebook' Tstchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in tster; (auto)cashing cheques in tster
// as well as (auto)depositing tster to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/tstchain/go-tstchain/contracts/chequebook/contract"
	"github.com/tstchain/go-tstchain/core/types"
	"github.com/tstchain/go-tstchain/crypto"
	"github.com/tstchain/go-tstchain/log"
	"github.com/tstchain/go-tstchain/swarm/services/swap/swap"
)
...
// * depositing tster to the chequebook
// * watching incoming tster
...
// Cash cashes the cheque by sending an Tstchain transaction.
