...
type RemoteAgent struct {
	...
	running int32 // running indicates whtster the agent is active. Call atomically
}
...
// whtster the solution was accepted or not (not can be both a bad pow as well as
