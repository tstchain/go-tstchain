...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllTstashProtocolChanges, new: AllTstashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllTstashProtocolChanges, new: AllTstashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllTstashProtocolChanges,
