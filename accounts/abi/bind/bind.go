...
// Package bind generates Tstchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-tstereum Wiki page:
// https://github.com/tstchain/go-tstchain/wiki/Native-DApps:-Go-bindings-to-Tstchain-contracts
package bind
...
// structured checks whtster a list of ABI data types has enough information to
