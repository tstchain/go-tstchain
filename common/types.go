...
// Address represents the 20 byte address of an Tstchain account.
...
// IsHexAddress verifies whtster a string can represent a valid hex-encoded
// Tstchain address or not.
