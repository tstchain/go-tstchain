...
// Trie is a Tstchain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb tstdb.Putter) error
}
...
func NewDatabase(db tstdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb tstdb.Putter) error {
