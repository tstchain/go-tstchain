...
// Whisper represents a dark communication interface through the Tstchain
...
// New creates a Whisper client ready to communicate through the Tstchain P2P network.
...
// param isP2P indicates whtster the message is peer-to-peer (should not be forwarded).
