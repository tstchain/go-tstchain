...
type downloadTester struct {
	...
	stateDb tstdb.Database // Database used by the tester for syncing from peers
	peerDb  tstdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = tstdb.NewMemDatabase()
