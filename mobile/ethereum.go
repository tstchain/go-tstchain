...
// Contains all the wrappers from the go-tstereum root package.
...
// the Tstchain network.
type SyncProgress struct {
	progress tstereum.SyncProgress
}
