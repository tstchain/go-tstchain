...
// Status implements accounts.Wallet, returning whtster the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain tstereum.ChainStateReader) {}
