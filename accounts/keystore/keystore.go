...
// See https://github.com/tstereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whtster the event notification loop is running
...
// HasAddress reports whtster a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Tstchain presale wallet and stores
