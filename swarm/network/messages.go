...
import (
	...
	"github.com/tstchain/go-tstchain/swarm/network/kademlia"
	"github.com/tstchain/go-tstchain/swarm/services/swap"
...
Timeout serves to indicate whtster the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whtster responder is expected to deliver content
