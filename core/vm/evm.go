...
type Context struct {
	// CanTransfer returns whtster the account contains
	// sufficient tster to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers tster from one account to the other
...
// EVM is the Tstchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) tstereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whtster the max code size has been exceeded
