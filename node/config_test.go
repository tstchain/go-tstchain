...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gtst.ipc", false, filepath.Join(os.TempDir(), "gtst.ipc")},
		{"data", "gtst.ipc", false, "data/gtst.ipc"},
		{"data", "./gtst.ipc", false, "./gtst.ipc"},
		{"data", "/gtst.ipc", false, "/gtst.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gtst.ipc", true, `\\.\pipe\gtst.ipc`},
		{"data", "gtst.ipc", true, `\\.\pipe\gtst.ipc`},
		{"data", `\\.\pipe\gtst.ipc`, true, `\\.\pipe\gtst.ipc`},
	}
