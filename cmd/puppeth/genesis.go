...
// newCppTstchainGenesisSpec converts a go-tstereum genesis block into a Parity specific
// chain specification format.
func newCppTstchainGenesisSpec(network string, genesis *core.Genesis) (*cppTstchainGenesisSpec, error) {
	// Only ethash is currently supported between go-tstereum and cpp-tstereum
	if genesis.Config.Tstash == nil {
...
// newParityChainSpec converts a go-tstereum genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-tstereum and Parity
	if genesis.Config.Tstash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	// Reconstruct the chain spec in Parity's format
	...
	spec.Engine.Tstash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Tstash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Tstash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Tstash.Params.BlockReward = (*hexutil.Big)(ethash.FrontierBlockReward)
	spec.Engine.Tstash.Params.HomesteadTransition = genesis.Config.HomesteadBlock.Uint64()
	spec.Engine.Tstash.Params.EIP150Transition = genesis.Config.EIP150Block.Uint64()
	spec.Engine.Tstash.Params.EIP160Transition = genesis.Config.EIP155Block.Uint64()
	spec.Engine.Tstash.Params.EIP161abcTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Tstash.Params.EIP161dTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Tstash.Params.EIP649Reward = (*hexutil.Big)(ethash.ByzantiumBlockReward)
	spec.Engine.Tstash.Params.EIP100bTransition = genesis.Config.ByzantiumBlock.Uint64()
	spec.Engine.Tstash.Params.EIP649Transition = genesis.Config.ByzantiumBlock.Uint64()
...
// newPyTstchainGenesisSpec converts a go-tstereum genesis block into a Parity specific
// chain specification format.
func newPyTstchainGenesisSpec(network string, genesis *core.Genesis) (*pyTstchainGenesisSpec, error) {
	// Only ethash is currently supported between go-tstereum and pytstereum
	if genesis.Config.Tstash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
