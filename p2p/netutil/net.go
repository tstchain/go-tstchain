...
// Contains reports whtster the given IP is contained in the list.
...
// IsLAN reports whtster an IP is a local network address.
...
// IsSpecialNetwork reports whtster an IP is located in a special-use network range
...
// CheckRelayIP reports whtster an IP relayed from the given sender IP
...
// SameNet reports whtster two IP addresses have an equal prefix of the given bit length.
...
// Contains whtster the given IP is contained in the set.
