...
// Package consensus implements different Tstchain consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Tstchain address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whtster a header conforms to the consensus rules of a
	...
	// VerifySeal checks whtster the crypto seal on a header is valid according to
