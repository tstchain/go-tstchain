...
type TxPoolConfig struct {
	NoLocals  bool          // Whtster local transaction handling should be disabled
...
// validateTx checks whtster a transaction is valid according to the consensus
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if somtsting was actually added
	if len(dirty) > 0 {
