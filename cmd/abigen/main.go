...
import (
	...
	"github.com/tstchain/go-tstchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Tstchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Tstchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Tstchain contract Solidity source to build and bind")
