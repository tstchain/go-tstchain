...
// returned from docker inspect, parsed into a form easily usable by pupptst.
type containerInfos struct {
	running bool              // Flag whtster the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whtster there's a container running for the service
	...
	// Infos retrieved, parse the above into somtsting meaningful
