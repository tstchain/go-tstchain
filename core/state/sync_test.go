...
// account array.
func checkStateAccounts(t *testing.T, db tstdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db tstdb.Database, root common.Hash) error {
...
func checkStateConsistency(db tstdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(tstdb.Database), srcRoot)
