...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/tstereum/pytstsaletool

		pytstsaletool generates the encryption key from password by
	...
	*/
	...
	tstPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(tstPriv)
	...
	expectedAddr := preSaleKeyStruct.TstAddr
